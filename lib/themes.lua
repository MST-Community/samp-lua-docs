...
ex = {
    colorThemes = {"Azul", "Rojo", "Marron", "Agua", "Negro", "Púrpura", "Negro-naranja", "Gris", "Negro2", "BH", "Rosa fucsia", "Azul-Negro", "Gris", "Fucsia2", "Blanco"},

    SwitchColorTheme = function(theme, imgui_lib)
       ...
       -- style.ButtonTextAlign = imgui_lib.ImVec2(0.0, 0.5)
        ...
        elseif theme == 6 then
           ...
           -- colors[clr.ChildWindowBg]         = ImVec4(0.30, 0.20, 0.39, 0.00);
            ...
            colors[clr.TitleBgActive]         = ImVec4(0.41, 0.19, 0.63, 0.99);
...
colors[clr.TextDisabled]           = ImVec4(0.50, 0.50, 0.50, 1.00)
colors[clr.WindowBg]               = ImVec4(0.34, 0.34, 0.34, 1.00)
colors[clr.ChildBg]                = ImVec4(0.00, 0.00, 0.00, 0.00)
 
colors[clr.Border]                 = ImVec4(0.43, 0.43, 0.50, 0.50)
colors[clr.BorderShadow]           = ImVec4(0.00, 0.00, 0.00, 0.00)
colors[clr.PopupBg]                = ImVec4(0.49, 0.49, 0.49, 1.00)
colors[clr.FrameBg]                = ImVec4(0.41, 0.41, 0.41, 1.00)
colors[clr.FrameBgHovered]         = ImVec4(0.48, 0.48, 0.48, 1.00)
colors[clr.FrameBgActive]          = ImVec4(0.55, 0.55, 0.55, 0.54)
colors[clr.TitleBg]                = ImVec4(0.61, 0.61, 0.61, 0.88)
colors[clr.TitleBgActive]          = ImVec4(0.44, 0.45, 0.43, 1.00)
colors[clr.TitleBgCollapsed]       = ImVec4(0.61, 0.61, 0.61, 1.00)
colors[clr.MenuBarBg]              = ImVec4(0.14, 0.14, 0.14, 1.00)
colors[clr.ScrollbarBg]            = ImVec4(0.02, 0.02, 0.02, 0.53)
colors[clr.ScrollbarGrab]          = ImVec4(0.31, 0.31, 0.31, 1.00)
colors[clr.ScrollbarGrabHovered]   = ImVec4(0.41, 0.41, 0.41, 1.00)
...
colors[clr.ButtonHovered]          = ImVec4(0.60, 0.60, 0.60, 1.00)
colors[clr.ButtonActive]           = ImVec4(0.60, 0.60, 0.60, 1.00)
colors[clr.Header]                 = ImVec4(0.57, 0.57, 0.58, 1.00)
colors[clr.HeaderHovered]          = ImVec4(0.58, 0.58, 0.58, 1.00)
colors[clr.HeaderActive]           = ImVec4(0.58, 0.58, 0.58, 1.00)
...
elseif theme == 14 then 
   ...
   -- colors[clr.ComboBg]                = ImVec4(0.08, 0.08, 0.08, 0.94)
    ...
    colors[clr.ScrollbarGrabHovered]   = ImVec4(0.41, 0.41, 0.41, 1.00)
    colors[clr.ScrollbarGrabActive]    = ImVec4(0.51, 0.51, 0.51, 1.00)
elseif theme == 15 then 
    
colors[clr.Text]                   = ImVec4(0.00, 0.00, 0.00, 1.00)
colors[clr.TextDisabled]           = ImVec4(0.50, 0.50, 0.50, 1.00)
colors[clr.WindowBg]               = ImVec4(0.94, 0.94, 0.94, 1.00)
colors[clr.ChildBg]                = ImVec4(0.00, 0.00, 0.00, 0.00)
colors[clr.PopupBg]                = ImVec4(0.94, 0.94, 0.94, 1.00)
colors[clr.Border]                 = ImVec4(0.43, 0.43, 0.50, 0.50)
colors[clr.BorderShadow]           = ImVec4(0.00, 0.00, 0.00, 0.00)
colors[clr.FrameBg]                = ImVec4(0.92, 0.92, 0.92, 0.54)
colors[clr.FrameBgHovered]         = ImVec4(0.26, 0.59, 0.98, 0.40)
colors[clr.FrameBgActive]          = ImVec4(0.26, 0.59, 0.98, 0.67)
colors[clr.TitleBg]                = ImVec4(0.97, 0.97, 0.97, 1.00)
colors[clr.TitleBgActive]          = ImVec4(0.82, 0.82, 0.82, 1.00)
colors[clr.TitleBgCollapsed]       = ImVec4(1.00, 1.00, 1.00, 0.51)
colors[clr.MenuBarBg]              = ImVec4(0.14, 0.14, 0.14, 1.00)
colors[clr.ScrollbarBg]            = ImVec4(0.71, 0.71, 0.71, 0.53)
colors[clr.ScrollbarGrab]          = ImVec4(0.52, 0.52, 0.52, 1.00)
colors[clr.ScrollbarGrabHovered]   = ImVec4(0.41, 0.41, 0.41, 1.00)
colors[clr.ScrollbarGrabActive]    = ImVec4(0.51, 0.51, 0.51, 1.00)
colors[clr.CheckMark]              = ImVec4(0.26, 0.59, 0.98, 1.00)
colors[clr.SliderGrab]             = ImVec4(0.24, 0.52, 0.88, 1.00)
...
colors[clr.ResizeGripHovered]      = ImVec4(0.26, 0.59, 0.98, 0.67)
colors[clr.ResizeGripActive]       = ImVec4(0.26, 0.59, 0.98, 0.95)
colors[clr.Tab]                    = ImVec4(0.18, 0.35, 0.58, 0.86)
colors[clr.TabHovered]             = ImVec4(0.26, 0.59, 0.98, 0.80)
colors[clr.TabActive]              = ImVec4(0.20, 0.41, 0.68, 1.00)
colors[clr.TabUnfocused]           = ImVec4(0.07, 0.10, 0.15, 0.97)
colors[clr.TabUnfocusedActive]     = ImVec4(0.14, 0.26, 0.42, 1.00)
colors[clr.PlotLines]              = ImVec4(0.61, 0.61, 0.61, 1.00)
colors[clr.PlotLinesHovered]       = ImVec4(1.00, 0.43, 0.35, 1.00)
colors[clr.PlotHistogram]          = ImVec4(0.90, 0.70, 0.00, 1.00)
colors[clr.PlotHistogramHovered]   = ImVec4(1.00, 0.60, 0.00, 1.00)
